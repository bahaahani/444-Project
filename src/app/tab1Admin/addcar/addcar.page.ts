...
newItem='';
newItem2='';
  constructor(public a:AlertController,public n:NavParams,public mod:ModalController,public d:CarService) {
this.showid=n.get('id');
  ...
  async addnewcar(){
   ...
   this.d.addnewcar1(this.car).then(()=>{alt.present();this.mod.dismiss()});
  }
